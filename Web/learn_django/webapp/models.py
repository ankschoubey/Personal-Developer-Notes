...
class SimpleContentbasedfiltering(models.Model):
    ...
    def __str__(self):
        return str([self.number_0,self.number_1,self.number_2,self.number_3,self.number_4,self.number_5,self.number_6,self.number_7,self.number_8,self.number_9])
...
class Movies(models.Model):
    ...
    def __str__(self):
        return str(self.movieid) + ' : ' + str(self.title) + '(' +str(self.year)+')'
...
class Ratings(models.Model):
    ...
    def __str__(self):
        return str([self.userid, self.movieid, self.rating, self.timestamp])
    class Meta:
        managed = True
        db_table = 'ratings'
